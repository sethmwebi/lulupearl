...
const Signin = () => {
	const { active, expanded, expandingTransition } = useSelector((state) => ({ ...state.signup }));
	...
	return (
		<div className="w-[280px] min-h-[550px] flex flex-col rounded-3xl shadow-xl relative overflow-hidden mx-auto mt-[40px]">
			<div className="w-full h-[250px] flex flex-col justify-end px-[1.8em] pb-[5em]">
				<motion.div
					className="w-[138%] h-[520px] absolute flex flex-col rounded-full -top-[290px] -left-[70px] transform rotate-60 bg-red-400 z-10"
					initial={false}
				...
				{active === "signup" && (
					<div className="w-full flex flex-col">
						...
						<h2 className={headerText}>An Account</h2>
